...
import bnbIcon from '../../../public/currencies-icons/bnb.png';
import ethIcon from '../../../public/currencies-icons/eth.png';
import btcIcon from '../../../public/currencies-icons/btc.png';
import manaIcon from '../../../public/currencies-icons/mana.png';
import vetIcon from '../../../public/currencies-icons/vet.png';
...
export default function MarketCell(
    ...
    return <CellStyles width={width} justify='space-evenly'>
        <Image src={icon} alt={value.name}/>
        <MarketCellStyles>
            <div>
                <span className="acronym">{acronym}</span>
                <PaneStyles>USDT</PaneStyles>
            ...
            <span className="grey-span">{value.name}</span>
        </MarketCellStyles>
